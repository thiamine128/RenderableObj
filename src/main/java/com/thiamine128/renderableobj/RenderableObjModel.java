...
public class RenderableObjModel {
    ...
    private RenderableObjModel(RenderableObjSettings settings)
    {
    ...
    static RenderableObjModel parse(ObjTokenizer tokenizer, RenderableObjSettings settings) throws IOException
    {
        var modelLocation = settings.modelLocation();
        var materialLibraryOverrideLocation = settings.mtlOverride();
        var model = new RenderableObjModel(settings);
    ...
    private class ModelMesh
    {
        ...
        public void bake(CompositeRenderable.PartBuilder<?> builder, IGeometryBakingContext configuration)
        {
            ...
            ResourceLocation texturePath = new ResourceLocation(mat.diffuseColorMap);
